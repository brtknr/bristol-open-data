...
export class BusMarker {
    ...
    _getBusIcon(selected) {
        ...
        if (selected) {
            return new busIcon({iconUrl: doubleDeckerBusSelected});
        } else {
            return new busIcon({iconUrl: doubleDeckerBus});
        }
    }
}
...
export class BusStop {
    ...
    _getStopIcon(selected) {
        ...
        if (selected) {
            return new stopIcon({iconUrl: busStop});
        } else {
            return new stopIcon({iconUrl: busStopNonSelected});
